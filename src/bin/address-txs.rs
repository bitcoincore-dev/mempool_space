...
const URL: &str = "https://mempool.space/api/address/1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa/txs";

fn main() {
    let n = 1;
    {
        let start = Instant::now();
        let address_txs = String::from("/address/1A1zP1eP5QGefi2DMPTfTL5SLmv7DivfNa/txs");
        let res = blocking(&address_txs);
